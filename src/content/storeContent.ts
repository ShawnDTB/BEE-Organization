export type StoreCategory =
  "Embroidery" | "Graphic Apparel" | "Teams & Organizations" | "Creator Merch";
...
export const storeProducts: readonly StoreProduct[] = [
  {
    ...
    description:
      "A clean starting point for staff, teams, businesses, departments, and organization apparel that needs a durable embroidered finish.",
    ...
    quantityGuidance:
      "Useful for small staff runs through recurring organization programs.",
  ...
  },
  {
    ...
    badge: "Creator-ready",
    description:
      "A substantial hoodie base intended for creator drops, community pieces, premium graphics, and embroidery-led capsule collections.",
  ...
  },
  {
    ...
    badge: "Group program",
    description:
      "A performance-oriented shirt base for teams, clubs, events, camps, and staff programs that need organized size runs and repeatability.",
  ...
  },
  {
    ...
    description:
      "A structured cap platform for staff, teams, creator collections, business branding, and group programs where a compact mark carries the identity.",
  ...
  },
  {
    ...
    description:
      "A versatile tee starting point for events, reunions, fundraisers, staff days, community programs, and detailed graphic artwork.",
    mediaLabel: "Cotton tee / graphic decoration",
    image: "/store/tee.svg",
    decoration: "Graphic decoration",
    bestFor: "Events, fundraisers, communities, one-time group orders",
    quantityGuidance:
      "Designed for simple size runs through larger coordinated orders.",
  ...
  },
  {
    ...
    description:
      "A polished layer for management teams, office staff, field teams, and organizations that want a more elevated uniform piece.",
    ...
    quantityGuidance:
      "Best when garment consistency and future reorders matter.",
  ...
  },
  {
    ...
    description:
      "A creator-focused tee base for artwork-led releases, community designs, channel milestones, limited runs, and repeat collection pieces.",
    mediaLabel: "Premium tee / creator artwork",
    image: "/store/tee.svg",
    decoration: "Graphic decoration",
    bestFor:
      "Streamers, creators, artists, gaming communities, personal brands",
    quantityGuidance:
      "Works well as a focused first product before expanding a catalog.",
  ...
  },
  {
    ...
    description:
      "A practical full-zip layer for staff, volunteers, coaching teams, departments, and recurring organization apparel programs.",
    mediaLabel: "Full-zip layer / organization branding",
    image: "/store/layer.svg",
    decoration: "Embroidery or graphic decoration",
    bestFor:
      "Organizations, staff teams, coaches, volunteers, recurring programs",
    quantityGuidance:
      "Structured for multi-size orders and future replenishment.",
...
export const storeCollections = [
  {
    ...
    description:
      "Polos, caps, and layers selected around consistency, professional presentation, and repeat ordering.",
    productSlugs: [
      "embroidered-performance-polo",
      "structured-embroidered-cap",
      "workwear-quarter-zip",
      "organization-full-zip",
    ],
    href: "#catalog",
  },
  {
    ...
    description:
      "Focused garment starting points for creator pilots, community launches, artwork-led releases, and future restocks.",
  ...
  },
  {
    ...
    description:
      "Flexible shirts and performance pieces for events, camps, clubs, fundraisers, reunions, and community programs.",
